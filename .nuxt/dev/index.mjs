...
import file_58_47_47_47C_58_47Projet_47annonces_45app_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js from 'file://C:/Projet/annonces-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import { digest, hash as hash$1 } from 'file://C:/Projet/annonces-app/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Projet/annonces-app/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Projet/annonces-app/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Projet/annonces-app/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Projet/annonces-app/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Projet/annonces-app/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Projet/annonces-app/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Projet/annonces-app/node_modules/errx/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Projet/annonces-app","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Projet/annonces-app/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47C_58_47Projet_47annonces_45app_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///C:/Projet/annonces-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"C:/Projet/annonces-app/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Projet/annonces-app/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Projet/annonces-app/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Projet/annonces-app/.data/kv"}));
...
const _XPoJlqNMg69zIcqQPkxEDvpa86qxrxjqAj_EiHquCLA = (function(nitro) {
...
const _21WlTThCRjlcL0pZFNhox4CG478Z1nsXP6CBlLEkQ_Y = (nitroApp) => {
...
const _EjhI9W = eventHandler((event) => {
...
const toggle_post$3 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
const COUT_BOOST = 2;
const boost_post = defineEventHandler(async (event) => {
  var _a;
  const session = await requireUserSession(event);
  ...
  const db = await getDb();
  const solde = (_a = db.data.credits[userId]) != null ? _a : 0;
  if (solde < COUT_BOOST) {
    throw createError({
      statusCode: 402,
      statusMessage: `Cr\xE9dits insuffisants (solde: ${solde}, co\xFBt: ${COUT_BOOST})`
    });
  }
  ...
  await db.write();
  return {
    message: "Annonce boost\xE9e pour 7 jours.",
    listing,
...
const me_get = defineEventHandler(async (event) => {
  ...
  const session = await requireUserSession(event);
  const db = await getDb();
  const balance = (_a = db.data.credits[session.user.id]) != null ? _a : 0;
...
const sold_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: sold_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const index_post$4 = defineEventHandler(async (event) => {
  ...
  if (listing.status === "published") {
    ...
    if (subscribers.length) {
      const sellerName = ((_a = db.data.sellers.find((s) => s.id === listing.userId)) == null ? void 0 : _a.name) || "Un vendeur";
      for (const subscriberId of subscribers) {
        const list = db.data.notifications[subscriberId] || [];
        list.push({
          id: nanoid(8),
          message: `${sellerName} a publi\xE9 une nouvelle annonce : ${listing.title}`,
  ...
  return {
    listing,
    message: contientMotInterdit ? "Annonce rejet\xE9e : contenu non conforme d\xE9tect\xE9 automatiquement." : "Annonce publi\xE9e avec succ\xE8s."
  };
});
...
const index_get = defineEventHandler(async (event) => {
  const session = await requireUserSession(event);
  const db = await getDb();
  const items = (db.data.notifications[session.user.id] || []).slice().sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
