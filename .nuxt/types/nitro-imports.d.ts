declare global {
  ...
  const upsertSellerFromOAuth: typeof import('../../server/utils/auth').upsertSellerFromOAuth
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Projet/annonces-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Projet/annonces-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { defineOAuthAppleEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/apple';
export { defineOAuthAtlassianEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/atlassian';
export { defineOAuthAuth0EventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/auth0';
export { defineOAuthAuthentikEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/authentik';
export { defineOAuthAzureB2CEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/azureb2c';
export { defineOAuthBattledotnetEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/battledotnet';
export { defineOAuthBoxEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/box';
export { defineOAuthCognitoEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/cognito';
export { defineOAuthDiscordEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/discord';
export { defineOAuthDropboxEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/dropbox';
export { defineOAuthFacebookEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/facebook';
export { defineOAuthGiteaEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/gitea';
export { defineOAuthGitHubEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/github';
export { defineOAuthGitLabEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/gitlab';
export { defineOAuthGoogleEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/google';
export { defineOAuthHerokuEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/heroku';
export { defineOAuthHubspotEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/hubspot';
export { defineOAuthInstagramEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/instagram';
export { defineOAuthKeycloakEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/keycloak';
export { defineOAuthKickEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/kick';
export { defineOAuthLineEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/line';
export { defineOAuthLinearEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/linear';
export { defineOAuthLinkedInEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/linkedin';
export { defineOAuthLiveChatEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/livechat';
export { defineOAuthMicrosoftEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/microsoft';
export { defineOAuthOidcEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/oidc';
export { defineOAuthOktaEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/okta';
export { defineOAuthOryEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/ory';
export { defineOAuthOsuEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/osu';
export { defineOAuthPaypalEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/paypal';
export { defineOAuthPolarEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/polar';
export { defineOAuthRiotGamesEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/riotgames';
export { defineOAuthRobloxEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/roblox';
export { defineOAuthSalesforceEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/salesforce';
export { defineOAuthSeznamEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/seznam';
export { defineOAuthShopifyCustomerEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/shopifyCustomer';
export { defineOAuthSlackEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/slack';
export { defineOAuthSpotifyEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/spotify';
export { defineOAuthSteamEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/steam';
export { defineOAuthStravaEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/strava';
export { defineOAuthTikTokEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/tiktok';
export { defineOAuthTwitchEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/twitch';
export { defineOAuthVKEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/vk';
export { defineOAuthWorkOSEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/workos';
export { defineOAuthXEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/x';
export { defineOAuthXSUAAEventHandler } from 'C:/Projet/annonces-app/node_modules/nuxt-auth-utils/dist/runtime/server/lib/oauth/xsuaa';
